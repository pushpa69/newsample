...
$questionArray[0][0]='<span style="text-decoration:underline;margin-left:0px;">1. Feasibility Study:</span> Financial and technical suitability 	for	an enterprise to migrate on cloud computing.';
	...
	$questionArray[1][4]='For medium and some small enterprises, ensure Service Oriented Architecture (SOA) is running which manages a relationship between customer and provider in various management activities.';
	...
	<div class="wrapper">			
		<div class="container">
			<div id="result">
				...
				<div>
					<p style="font-size:20px;color:DarkGreen ;">1.Cloud Requirement Stage:</p><br>					
				...
				<div style="margin-left:80px;	">
					...
					<p style="font-size:20px;color:DarkGreen ;">2.Cloud Preparation Stage:</p>
					<p style="font-size:17px;color:Maroon ;text-decoration:underline;">Your Preparedness</p><br>
					...
					<p style="font-size:17px;color:Maroon ;text-decoration:underline;">What you need to prepare for</p><br>
						...
						<?php }}?>							
						 ...
						 <br>
					<p style="font-size:20px;color:DarkGreen ;" >3.Cloud Migration Stage:</p>
					<p style="font-size:17px;color:Maroon ;text-decoration:underline;">Your Preparedness</p><br>
						...
						<?php }}?>							
							<br>
					<p style="font-size:17px;color:Maroon ;text-decoration:underline;">What you need to be aware of</p> <br>
